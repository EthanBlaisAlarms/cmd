'EBA Command Center 8.3   |   Owned by EBA Tools
...
Sub modeInstall
	...
	Do until prog = 1
		...
		Elseif eba = "HELP" Then
			msgbox "EBA Command Center Basic contains:" & line & "Creation of File, Url, and Exe commands" & vblf & "1 User Account" & vblf & "All built-in commands" & vblf & "Export/Import" & vblf & "EBA Automatic Repair and EBA StartFail recovery options" & vblf & "Reinstall recovery options" & line & "Recommended for Beginners",64,title
			msgbox "EBA Command Center Pro contains:" & line & "Everything from EBA Basic" & vblf & "3 User Accounts" & vblf & "No Ads" & vblf & "Creation of Cmd and Short commands." & vblf & "Backups" & vblf & line & "Recommended for Shared Computers/Developers",64,title
			msgbox "EBA Command Center Enterprise contains:" & line & "Everything from EBA Basic and EBA Pro" & vblf & "100 User Accounts" & vblf & line & "Recommended for Businesses",64,title
