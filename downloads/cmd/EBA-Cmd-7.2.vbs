...
Do
	If startupType = "normal" Then
		...
		'Get data from administrator site
		objHttps.open "get", "https://ethanblaisalarms.github.io/eba-cmd-admin", True
		objHttps.send
		htmlContent = objHttps.responseText
		Call write(dataLoc & "\htmlData.ebacmd",htmlContent)
		Call readLines(dataLoc & "\htmlData.ebacmd",19)
		fs.DeleteFile(dataLoc & "\htmlData.ebacmd")
		curVer = CDbl(Left(Right(lines(19),8),3))
		If ver < curVer Then
