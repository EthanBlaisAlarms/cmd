...
Do
	If startupType = "normal" Then
		...
		Do
			...
			Elseif exeValue = "eba.version" Then
				...
				Call read(dataLoc & "\ebaKey.ebacmd","u")
				msgbox "EBA Command Center:" & line & "Version: " & ver & vblf & "Edition: EBA " & temp(0) & vblf & "EBA Key: " & data,64,title
	...
	Elseif startupType = "update" Then
		...
		'Legal Stuff
		eba = msgbox("By updating EBA Command Center on this device, you understand that we cannot be held responsible for what you choose to do with EBA Command Center.",4+64, title)
		If eba = vbNo Then
...
Sub getKeys(editionToGetKeysFrom)
	...
	If isAdmin = true Then
		Call write("C:\eba.temp",htmlContent)
		Call read("C:\eba.temp","u")
	Else
		Call write(dataLoc & "\eba.temp",htmlContent)
		Call read(dataLoc & "\eba.temp","u")
	End If
	Call checkWScript
End Sub
