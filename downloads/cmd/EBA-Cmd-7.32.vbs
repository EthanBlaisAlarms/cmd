...
Do
	...
	Elseif startupType = "install" Then
		...
		'Install Setup
		programLoc = inputbox("We're about to install EBA Command Center. Where would you like to install? This cannot be changed later without reinstalling!",title,programLoc)
		If Not foldExists(programLoc) Then
